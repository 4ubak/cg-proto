...
func (x *Session) Reset() {
	*x = Session{}
	mi := &file_users_auth_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Session) Descriptor() ([]byte, []int) {
	return file_users_auth_proto_rawDescGZIP(), []int{13}
}
...
const file_users_auth_proto_rawDesc = "" +
	"\n" +
	"\x10users/auth.proto\x12\rusers.auth.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"D\n" +
	...
	"\vGetSessions\x12!.users.auth.v1.GetSessionsRequest\x1a\".users.auth.v1.GetSessionsResponseB)Z'gitlab.com/xakpro/cg-proto/gen/go/usersb\x06proto3"
...
var file_users_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
