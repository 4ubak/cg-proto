...
const file_users_auth_auth_proto_rawDesc = "" +
	...
	"\vGetSessions\x12!.users.auth.v1.GetSessionsRequest\x1a\".users.auth.v1.GetSessionsResponseB5Z3gitlab.com/xakpro/cg-proto/gen/go/users/auth;authv1b\x06proto3"
